import { Component, ComponentOptions, IComponentBindings, $$, QueryEvents, IBuildingQueryEventArgs, Initialization } from 'coveo-search-ui';
...
export class HelloWorld extends Component {
  ...
  static options: IHelloWorldOptions = {
    dummyOptionText: ComponentOptions.buildStringOption({
      defaultValue: 'Coveo Pokemon Search Engine'
    }),
